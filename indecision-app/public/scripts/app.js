...
var Traveler = function (_Person) {
	...
	_createClass(Traveler, [{
		...
		key: 'getGreeting',
		value: function getGreeting() {
			var greatings = _get(Traveler.prototype.__proto__ || Object.getPrototypeOf(Traveler.prototype), 'getGreeting', this).call(this);
...
var me = new Traveler('Konrad', 33, 'Bielsko-Biała');
console.log(me.getGreeting());
